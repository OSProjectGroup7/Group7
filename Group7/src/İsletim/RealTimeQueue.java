...
public class RealTimeQueue { //Önceliği 0 olanlar için gerçek zaman kuyruğuna girer ve fcfs algoritmasını çalıştırır.
	...
	int FCFS_execute(int zaman) { //fcfs algoritması.
